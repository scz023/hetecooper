...
class HeteV2VNetFuse(nn.Module):
    def __init__(self, args):
        super(HeteV2VNetFuse, self).__init__()
        ...
        self.fusion_net = V2VNetFusion(args)
    ...
    def forward(self, middle_info, neb_middle_info=None):
        ...
        if neb_middle_info:
            ...
            neb_spatial_features_2d = torch.nn.functional.interpolate(neb_spatial_features_2d, size=(H, W), mode='bilinear', align_corners=False)
