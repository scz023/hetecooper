...
from opencood.models.fuse_modules.homocooper_fuse import Homocooper
...
class PointPillarHomocooper(nn.Module):
    def __init__(self, args):
        super(PointPillarHomocooper, self).__init__()
        ...
        self.fusion_net = Homocooper(args['homocooper_fusion'])
        self.multi_scale = args['homocooper_fusion']['multi_scale']
    ...
    def forward(self, data_dict):
        ...
        # 提取初始BEV特征的尺寸
        # origin_bevfeature_size = batch_dict['spatial_features'].shape[1:] 
