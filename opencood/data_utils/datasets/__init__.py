...
from opencood.data_utils.datasets.intermediate_fusion_dataset_withneb import IntermediateFusionDatasetWithneb
from opencood.data_utils.datasets.intermediate_fusion_dataset_dair_withneb import IntermediateFusionDatasetDAIRWithneb
...
__all__ = {
    ...
    'IntermediateFusionDatasetWithneb': IntermediateFusionDatasetWithneb,
    'IntermediateFusionDatasetDAIRWithneb': IntermediateFusionDatasetDAIRWithneb
}
...
def build_dataset(dataset_cfg, visualize=False, train=True, dataset_cfg_neb = None):
    ...
    assert dataset_name in ['LateFusionDataset', 'EarlyFusionDataset',
                            ...
                            'IntermediateFusionDatasetDAIR', 'IntermediateFusionDatasetWithneb',
                            'IntermediateFusionDatasetDAIRWithneb'], error_message
